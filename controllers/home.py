...
class HomeController:
    ...
    def create_random_wheels(self):
        amount_of_random_wheels = 10000
        self.model.my_wheels_as_df = creator_random_wheels.get_my_wheels_from_files_as_df()
        self.model.list_of_random_df_wheels = creator_random_wheels.get_list_of_random_df_wheels(self.model.my_wheels_as_df, amount_of_random_wheels)
    ...
    def make_sektors_stats_my_wheels(self):
        ...
        self.model.avg_score_wins_num_in_sektor, self.model.sum_score_wins_num_in_sektor, self.model.real_roullete_value_my_wheels = sektors_stats.get_df_sektor_stats(self.model.my_wheels_as_df)
    ...
    def calulate_winners_in_sektors(self):
        ...
        df_to_html(df_len_win_nums_among_randoms_sektors,
                   f'df_len_win_nums_among_randoms_sektors_{len(self.model.list_of_random_df_wheels[0])} wheels ')
