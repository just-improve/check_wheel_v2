...
def get_df_score_for_df_wheels(df):
    columns = ['count', 'avg_score', 'len_winning_count', 'sum_score']
    ...
    for num in range(len(df)):
        ...
        df_score['avg_score'].iloc[num] = ev
        df_score['len_winning_count'].iloc[num] = len_of_winning_counts
        df_score['sum_score'].iloc[num] = df_score['len_winning_count'].iloc[num] * df_score['avg_score'].iloc[num]
    return df_score
